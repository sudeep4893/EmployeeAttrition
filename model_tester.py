...
y = tar_df
X_trainset, X_testset, y_trainset, y_testset = train_test_split(X, y, test_size=0.1, random_state=randint(0, 9))

y_testset = y_testset[0:1]
X_testset = X_testset[0:1]
print(X_testset)
# load the model from disk
from sklearn.externals import joblib
filename = 'finalized_model.sav'
loaded_model = joblib.load(filename)
result = loaded_model.predict(X_testset)

from sklearn import metrics
print("Test accuracy_score: ", metrics.accuracy_score(y_testset, result))
